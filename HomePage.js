								...
								<table className="table ">
									...
									<tbody className='table-body'>
										...
										<tr>
											<td>
											<span className="badge badge-lg badge-dot">
											<i className="bg-warning"></i>Sesiones de Copia SCP:
											</span>
											</td>
											<td></td>
											<td>0</td>
										...
										<tr>
											<td>
											<span className="badge badge-lg badge-dot">
											<i className="bg-success"></i>Sesiones de Conexion Windows:
											</span>
											</td>
											<td></td>
											<td>1</td>
										...
										<tr>
											<td>
											<span className="badge badge-lg badge-dot">
											<i className="bg-success"></i>Sesiones de Conexion SSH/Telnet:
											</span>
											</td>
											<td></td>
											<td>1</td>
										...
										<tr>
											<td>
											<span className="badge badge-lg badge-dot">
											<i className="bg-success"></i>Conexion de Aplicaciones Windows:
											</span>
											</td>
											<td></td>
											<td>2</td>
